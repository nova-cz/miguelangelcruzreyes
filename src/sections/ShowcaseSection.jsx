...
const projects = [
  {
    ...
    imgPath: "/images/project1.png", // <- CORREGIDO
    bgColor: "#E8D7FF",
    accentColor: "#8B5CF6",
  ...
  },
  {
    ...
    imgPath: "/images/project3.png", // <- CORREGIDO
    bgColor: "#FFEFDB",
    accentColor: "#F59E0B",
  ...
  },
  {
    ...
    imgPath: "/images/project4.png", // <- CORREGIDO
    bgColor: "#FFE7EB",
    accentColor: "#EC4899",
        ...
        <div className="mb-20">
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-white/5 border border-white/10">
              ...
              <span className="text-center text-sm text-gray-400">My projects</span>
            </div>
          </div>
